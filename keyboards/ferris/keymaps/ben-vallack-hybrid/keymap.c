...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
      KC_Y,   KC_C,     KC_E,     KC_M,    KC_A,    						KC_Z,  MT(MOD_RGUI,KC_F),   MT(MOD_RALT,KC_U),   KC_I,  KC_BSPC,
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_O,    KC_S,    MT(MOD_LALT,KC_R),    MT(MOD_LGUI,KC_T),    KC_G,  	KC_P,   KC_H,   KC_J,  KC_K,  KC_L,
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_Q,   KC_V,  KC_W,   KC_D,  KC_X,     							KC_B,   KC_N,   TD(DANCE_2),   TD(DANCE_1),   TD(DANCE_3),
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
